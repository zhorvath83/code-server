FROM codercom/code-server:4.5.1 AS code-server
...
RUN apt-get update -y && \
    apt-get install -y --no-install-recommends net-tools iputils-ping wget vim jq gnupg software-properties-common python3 python3-pip build-essential python-dev mc ca-certificates unzip bzr curl git-extras && \
    ## Terraform repo
